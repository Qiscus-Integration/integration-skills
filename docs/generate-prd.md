...
```bash
[PM] generate-prd  →  docs/features/[slug]/prd.md   ← THIS SKILL
                                 ↓
[Designer] design-spec reads prd.md
```
...
| ------ | ------------------ |
| `references/notion-templated.md` | Loaded during Phase 10 when `output_format = notion` |
