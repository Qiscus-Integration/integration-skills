...
- No PRD or requirement input is provided — run `prd-plan` first
...
[PM] prd-plan  →  prd.md
                         ↓
[Designer] design-plan reads prd.md  →  design-spec.md  ← YOU ARE HERE
                                           ↓
...
3. If the file does not exist, stop and say:
   ...
   Please ask the PM to run $prd-plan first and share the feature slug.
   ```
...
Next step: hand prd.md + design-spec.md to the QA Engineer and ask them to run $qa-plan
```
