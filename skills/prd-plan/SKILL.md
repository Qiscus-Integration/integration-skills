...
- Open `references/prd-quality-checklist.md` when a deeper review checklist is needed.
...
- Load `assets/templates/notion-templated.md.template` if a Notion template structure is required.
...
[Designer] design-plan reads prd.md  →  design-spec.md
                                           ↓
[QA] qa-plan reads prd.md + design-spec.md  →  qa-testplan.md
                                                       ↓
...
- `references/prd-quality-checklist.md` contains a review checklist for scope, consistency, edge cases, and handoff readiness.
- `assets/templates/notion-templated.md.template` contains the Notion-ready PRD template structure.
